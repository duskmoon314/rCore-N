...
pub type DTR_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCR_SPEC, DTR_A, O>;
...
pub type RTS_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCR_SPEC, RTS_A, O>;
...
pub type LOOP_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCR_SPEC, LOOP_A, O>;
...
pub type AFCE_W<'a, const O: u8> = crate::BitWriter<'a, u8, MCR_SPEC, AFCE_A, O>;
...
pub type FUNCTION_W<'a, const O: u8> = crate::FieldWriter<'a, u8, MCR_SPEC, u8, FUNCTION_A, 2, O>;
