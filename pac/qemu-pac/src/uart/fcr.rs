...
pub type FIFOE_W<'a, const O: u8> = crate::BitWriter<'a, u8, FCR_SPEC, bool, O>;
#[doc = "Field `rfifor` writer - "]
pub type RFIFOR_W<'a, const O: u8> = crate::BitWriter<'a, u8, FCR_SPEC, bool, O>;
#[doc = "Field `xfifor` writer - "]
pub type XFIFOR_W<'a, const O: u8> = crate::BitWriter<'a, u8, FCR_SPEC, bool, O>;
#[doc = "\n\nValue on reset: 0"]
...
pub type DMAM_W<'a, const O: u8> = crate::BitWriter<'a, u8, FCR_SPEC, DMAM_AW, O>;
...
pub type TFT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, FCR_SPEC, u8, TFT_AW, 2, O>;
...
#[doc = "Field `rt` writer - "]
pub type RT_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, FCR_SPEC, u8, RT_AW, 2, O>;
