...
pub type ERBFI_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, ERBFI_A, O>;
...
pub type ETBEI_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, ETBEI_A, O>;
...
pub type ELSI_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, ELSI_A, O>;
...
pub type EDSSI_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, EDSSI_A, O>;
...
pub type RS485_INT_EN_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, RS485_INT_EN_A, O>;
...
pub type PTIME_W<'a, const O: u8> = crate::BitWriter<'a, u8, IER_SPEC, PTIME_A, O>;
