...
pub type DLS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LCR_SPEC, u8, DLS_A, 2, O>;
...
pub type STOP_W<'a, const O: u8> = crate::BitWriter<'a, u8, LCR_SPEC, STOP_A, O>;
...
pub type PEN_W<'a, const O: u8> = crate::BitWriter<'a, u8, LCR_SPEC, PEN_A, O>;
...
pub type EPS_W<'a, const O: u8> = crate::FieldWriterSafe<'a, u8, LCR_SPEC, u8, EPS_A, 2, O>;
...
pub type BC_W<'a, const O: u8> = crate::BitWriter<'a, u8, LCR_SPEC, bool, O>;
...
pub type DLAB_W<'a, const O: u8> = crate::BitWriter<'a, u8, LCR_SPEC, DLAB_A, O>;
