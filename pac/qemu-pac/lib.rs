#![doc = "Peripheral access API for QEMU-16550 microcontrollers (generated using svd2rust v0.27.2 ( ))\n\nYou can find an overview of the generated API [here].\n\nAPI features to be included in the [next]
...
pub mod uart {
    ...
    pub mod ier {
        ...
        pub type RS485_INT_EN_W<'a, const O: u8> =
            crate::BitWriter<'a, u8, IER_SPEC, RS485_INT_EN_A, O>;
    ...
    pub mod fcr {
        ...
        pub type TFT_W<'a, const O: u8> =
            crate::FieldWriterSafe<'a, u8, FCR_SPEC, u8, TFT_AW, 2, O>;
    ...
    pub mod mcr {
        ...
        pub type FUNCTION_W<'a, const O: u8> =
            crate::FieldWriter<'a, u8, MCR_SPEC, u8, FUNCTION_A, 2, O>;
